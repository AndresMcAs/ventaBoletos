...
import vistas.RegistrarPelicula;
import vistas.RegistrarSala;
import vistas.RegistroHorarios;
import vistas.ReservaAsiento;
import vistas.VentanaCartelera;
...
public class Cine extends javax.swing.JFrame {
  ...
  */
  public final void inicializa() {
    ...
    Color color = new Color(0, 40, 136);
    ...
    salir.setFont(new java.awt.Font("Century", 1, 12));  
    ...
    layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(212, 212, 212)
                        .addComponent(titulo, javax.swing.GroupLayout.PREFERRED_SIZE, 394, 
    ...
    cartelera.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
        VentanaCartelera cartelera = new VentanaCartelera();
    ...
    horarios.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
        RegistroHorarios horarios = new RegistroHorarios();
    ...
    salir.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
             ...
             int respuesta = JOptionPane.showConfirmDialog(null, confirmacion,
                               "Cine", JOptionPane.YES_NO_OPTION);
